import {calculateConnectionPoints, CANVAS_EVENTS, FgnNodeModel, useFgnEventBus} from "fg-next-draw-canvas";
import {useEffect} from "react";

export function useInitDataLocalHandler(): void {

    const eventBus = useFgnEventBus();
    ...
    useEffect(() => {
        eventBus.emit(CANVAS_EVENTS.NODES_REPLACED, nodes);
    });
}